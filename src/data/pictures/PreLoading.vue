...
<!--  <?xml version="1.0" encoding="UTF-8" standalone="no"?>-->
  <svg xmlns="http://www.w3.org/2000/svg"
       version="1.0" width="64px" height="72px"
       viewBox="0 0 128 143" xml:space="preserve"><rect x="0" y="0" width="100%" height="100%" fill="#FFFFFF" />
    <path fill="#000000"
    ...
    <path fill="#000000" d="M64 73.6l-3-.4.8-34 2.2-3.7 2.2 3.7.8 34z"><animateTransform attributeName="transform" type="rotate" from="0 64 79" to="360 64 79" dur="1200ms" repeatCount="indefinite"></animateTransform></path></svg>
  </div>
</template>
